...
{
    [Entity(TableCnName = "整机生产订单表",TableName = "OCP_PrdMO",DetailTable =  new Type[] { typeof(OCP_PrdMODetail)},DetailTableCnName = "整机生产订单明细表",DBServer = "ServiceDbContext")]
    public partial class OCP_PrdMO:ServiceEntity
    {
        /// <summary>
       ///主键ID
       /// </summary>
       ...
       [Display(Name ="整机生产订单明细表")]
       [ForeignKey("ID")]
       public List<OCP_PrdMODetail> OCP_PrdMODetail { get; set; }
