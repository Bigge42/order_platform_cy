...
{
    [Entity(TableCnName = "金工生产订单表",TableName = "OCP_JGPrdMO",DetailTable =  new Type[] { typeof(OCP_JGPrdMODetail)},DetailTableCnName = "金工生产订单明细表",DBServer = "ServiceDbContext")]
    public partial class OCP_JGPrdMO:ServiceEntity
    {
        /// <summary>
       ///主键ID
       /// </summary>
       ...
       [Display(Name ="金工生产订单明细表")]
       [ForeignKey("ID")]
       public List<OCP_JGPrdMODetail> OCP_JGPrdMODetail { get; set; }
