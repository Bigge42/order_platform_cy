...
{
    [Entity(TableCnName = "采购跟踪",TableName = "OCP_POUnFinishTrack",DBServer = "ServiceDbContext")]
    public partial class OCP_POUnFinishTrack:ServiceEntity
    {
        /// <summary>
       ///采购订单编号
       /// </summary>
       ...
       ///采购申请单创建日期
       /// </summary>
       [Display(Name ="采购申请单创建日期")]
       [Column(TypeName="datetime")]
       [Editable(true)]
       public DateTime? CGSQCreateDate { get; set; }

       /// <summary>
       ///采购申请单审核日期
       /// </summary>
       [Display(Name ="采购申请单审核日期")]
       [Column(TypeName="datetime")]
       [Editable(true)]
       ...
       [Column(TypeName="datetime")]
       [Editable(true)]
       public DateTime? LatestReplyDeliveryDate { get; set; }
       ...
       [Column(TypeName="datetime")]
       [Editable(true)]
       public DateTime? LatestQualityCheckDate { get; set; }
