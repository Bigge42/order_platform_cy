...
{
    [Entity(TableCnName = "采购明细",TableName = "OCP_PurchaseDetail",DBServer = "ServiceDbContext")]
    public partial class OCP_PurchaseDetail:ServiceEntity
    {
        /// <summary>
       ///采购记录ID
       /// </summary>
       ...
       [Editable(true)]
       [Required(AllowEmptyStrings=false)]
       public string PurchaseDocNumber { get; set; }
