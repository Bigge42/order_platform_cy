...
{
    /// <summary>
    /// 采购订单头ESB数据实体 - 对应接口 SearchPoor
    /// </summary>
    public class ESBPurchaseOrderData
    {
        /// <summary>
        /// 采购订单主键 - 对应实体 FID
        /// 必填字段
        ...
        /// <summary>
        /// 业务类型 - 对应实体 FBILLTYPENAME
        /// 可选字段，最大长度20
        /// </summary>
        public string FBILLTYPENAME { get; set; }

        /// <summary>
        /// 供应商ID - 对应实体 FSUPPLIERID
        /// 可选字段
        /// </summary>
        public int? FSUPPLIERID { get; set; }

        /// <summary>
        /// 采购负责人 - 对应实体 FCREATENAME
        /// 可选字段，最大长度50
        /// </summary>
    ...
    /// <summary>
    /// 采购订单明细ESB数据实体 - 对应接口 SearchPoorEntry
    /// </summary>
    public class ESBPurchaseOrderDetailData
    {
        /// <summary>
        /// 采购订单明细主键
        /// 必填字段
    ...
    /// <summary>
    /// 采购进度追踪ESB数据实体 - 对应接口 SearchPoorProgress
    /// 根据最新接口字段更新 - 2024年12月
    /// </summary>
    public class ESBPurchaseOrderProgressData
    {
        /// <summary>
        /// 采购订单明细主键
        /// 必填字段
        ...
        /// 可选字段，最大长度120
        /// </summary>
        public string FCGSQCREATEDATE { get; set; }

        /// <summary>
        /// 采购申请审核时间
        /// 可选字段，最大长度120
        /// </summary>
        public string FCGSQAPPROVEDATE { get; set; }
