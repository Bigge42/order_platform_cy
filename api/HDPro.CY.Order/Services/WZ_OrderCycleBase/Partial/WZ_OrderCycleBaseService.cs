...
WHERE ProductionLine IS NOT NULL AND LTRIM(RTRIM(ProductionLine)) <> N'';";
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (request.ProductionLines != null && request.ProductionLines.Count > 0)
            {
                orderQuery = orderQuery.Where(p => request.ProductionLines.Contains(p.AssignedProductionLine));
            }
