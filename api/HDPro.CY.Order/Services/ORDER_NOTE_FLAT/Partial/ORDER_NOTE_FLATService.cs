/*
 *所有关于ORDER_NOTE_FLAT类的业务代码应在此处编写
*可使用repository.调用常用方法，获取EF/Dapper等信息
*如果需要事务请使用repository.DbContextBeginTransaction
*也可使用DBServerProvider.手动获取数据库相关信息
*用户信息、权限、角色等使用UserContext.Current操作
*ORDER_NOTE_FLATService对增、删、改查、导入、导出、审核业务代码扩展参照ServiceFunFilter
*/
...
namespace HDPro.CY.Order.Services
{
    ...
    {
        private readonly IORDER_NOTE_FLATRepository _repository;//访问数据库
        ...
        /// 可在此处添加ORDER_NOTE_FLAT特有的初始化代码
        /// </summary>
        protected override void InitCYOrderSpecific()
        {
            base.InitCYOrderSpecific();
            // 在此处添加ORDER_NOTE_FLAT特有的初始化逻辑
        }

        /// <summary>
        /// 重写CY.Order项目通用数据验证方法
        /// 可在此处添加ORDER_NOTE_FLAT特有的数据验证逻辑
        /// </summary>
