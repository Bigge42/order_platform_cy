...
using gridreport;
using HDPro.Core.Report.PInvokeWindows;
using BinaryObject = HDPro.Core.Report.PInvokeWindows.BinaryObject;
using E2IMGOption = HDPro.Core.Report.PInvokeWindows.E2IMGOption;

namespace HDPro.Core.common
{
