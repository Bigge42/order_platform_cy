...
export default function(){
    ...
    const columns = [{field:'ID',title:'主键ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'ApiName',title:'接口名称',type:'string',sort:true,width:220,align:'left'},
                       {field:'ApiPath',title:'接口路径',type:'string',sort:true,width:220,align:'left'},
                       {field:'HttpMethod',title:'请求方法',type:'string',sort:true,width:110,align:'left'},
                       {field:'RequestParams',title:'请求参数',type:'string',sort:true,width:110,align:'left'},
                       {field:'ResponseLength',title:'响应数据长度（字节数）',type:'long',sort:true,width:80,align:'left'},
                       {field:'StatusCode',title:'HTTP状态码',type:'int',sort:true,width:80,align:'left'},
                       {field:'Status',title:'调用状态',type:'int',sort:true,width:80,align:'left'},
                       {field:'ErrorMessage',title:'错误信息',type:'string',sort:true,width:110,align:'left'},
                       {field:'StartTime',title:'调用开始时间',type:'datetime',sort:true,width:150,align:'left'},
                       {field:'EndTime',title:'调用结束时间',type:'datetime',sort:true,width:150,align:'left'},
                       {field:'ElapsedMs',title:'耗时（毫秒）',type:'long',sort:true,width:80,align:'left'},
                       {field:'DataCount',title:'返回数据条数',type:'int',sort:true,width:80,align:'left'},
                       {field:'Remark',title:'备注',type:'string',sort:true,width:220,align:'left'},
