...
export default function(){
    ...
    const key = table.key;
    const editFormFields = {"FID":"","FENTRYID":"","ProductionOrderStatus":"","PlanTraceNo":"","MaterialID":"","MaterialNumber":"","MaterialName":"","PlanTaskMonth":"","PlanTaskWeek":"","Urgency":"","ProductCategory":"","ProductionQty":"","InboundQty":"","UnInboundQty":"","OverdueQty":"","PlanCompleteDate":"","ActualCompleteDate":"","PickMtrlDate":""};
    const editFormOptions = [[{"title":"生产订单ID","field":"FID"},
                               {"title":"生产订单明细ID","field":"FENTRYID"},
    ...
    const searchFormFields = {"FENTRYID":"","ProductionOrderStatus":"","PlanTraceNo":"","MaterialID":""};
    const searchFormOptions = [[{"title":"明细ID","field":"DetailID","type":"like"},{"title":"主表ID","field":"ID","type":"like"},{"title":"行号","field":"LineNumber","type":"like"},{"title":"生产订单ID","field":"FID","type":"like"}],[{"title":"生产订单明细ID","field":"FENTRYID","type":"like"},{"title":"生产订单状态","field":"ProductionOrderStatus","type":"like"},{"title":"计划跟踪号","field":"PlanTraceNo","type":"like"},{"title":"物料ID","field":"MaterialID","type":"like"}]];
