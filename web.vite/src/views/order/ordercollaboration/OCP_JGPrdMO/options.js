...
export default function(){
    ...
    const key = table.key;
    const editFormFields = {"PlanTaskMonth":"","PlanTaskWeek":"","Urgency":"","MOAuditDate":"","ProductionType":"","ProductionQty":"","InboundQty":"","UnInboundQty":"","OverdueQty":"","OverdueDays":"","Operation":""};
    ...
    const searchFormFields = {"MOAuditDate":"","ProductionType":"","ProductionQty":"","OverdueDays":""};
    const searchFormOptions = [[{"title":"生产单据号","field":"ProductionOrderNo","type":"like"},{"title":"月度任务","field":"PlanTaskMonth","type":"like"},{"title":"周任务","field":"PlanTaskWeek","type":"like"},{"title":"紧急等级","field":"Urgency","type":"like"}],[{"title":"生产订单审核时间","field":"MOAuditDate","type":"datetime"},{"title":"生产类型","field":"ProductionType","type":"like"},{"title":"生产数量","field":"ProductionQty","type":"like"},{"title":"超期天数","field":"OverdueDays","type":"like"}]];
    const columns = [{field:'ID',title:'主键ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Operation',title:'操作',type:'string',sort:true,width:220,align:'left'},
    ...
    const detail =  {
                    ...
                    columns: [{field:'DetailID',title:'明细ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'ProductionQty',title:'生产数量',type:'decimal',sort:true,width:110,edit:{type:''},align:'left'},
                       ...
                       {field:'PickMtrlDate',title:'领料日期',type:'date',sort:true,width:150,edit:{type:'datetime'},align:'left'},
                       {field:'CreateID',title:'创建人ID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'CreateDate',title:'创建日期',type:'datetime',width:150,hidden:true,align:'left'},
                       {field:'Creator',title:'创建人',type:'string',width:100,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:100,hidden:true,align:'left'},
