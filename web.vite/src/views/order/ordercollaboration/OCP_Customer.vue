 ...
 *业务请在@/extension/order/ordercollaboration/OCP_Customer.jsx或OCP_Customer.vue文件编写
...
import extend from "@/extension/order/ordercollaboration/OCP_Customer.jsx";
import viewOptions from './OCP_Customer/options.js'
