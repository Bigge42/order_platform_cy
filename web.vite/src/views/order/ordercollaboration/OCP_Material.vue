 ...
 *业务请在@/extension/order/ordercollaboration/OCP_Material.jsx或OCP_Material.vue文件编写
...
import extend from "@/extension/order/ordercollaboration/OCP_Material.jsx";
import viewOptions from './OCP_Material/options.js'
