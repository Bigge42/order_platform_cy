 ...
 *业务请在@/extension/order/ordercollaboration/OCP_Supplier.jsx或OCP_Supplier.vue文件编写
...
import extend from "@/extension/order/ordercollaboration/OCP_Supplier.jsx";
import viewOptions from './OCP_Supplier/options.js'
