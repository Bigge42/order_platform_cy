...
export default function(){
    ...
    const editFormOptions = [[{"title":"规则名称","required":true,"field":"RuleName","type":"text","comparationList":[{"key":"text","value":""},
                               {"key":"EMPTY","value":"空"},
                               ...
                               {"key":"EMPTY","value":"空"},
                               {"key":"NOT_EMPTY","value":"不空"}]}],
                              [{"dataKey":"预警字段名","data":[],"title":"字段名","required":true,"field":"FieldName","type":"selectList","comparationList":[{"key":"selectList","value":"select多选"},
                               {"key":"EMPTY","value":"空"},
                               {"key":"NOT_EMPTY","value":"不空"}]},
                              ...
                              [{"dataKey":"是否触发OA流程","data":[],"title":"是否触发OA流程","required":true,"field":"TriggerOA","type":"select","comparationList":[{"key":"select","value":"select"},
                               {"key":"EMPTY","value":"空"},
                               {"key":"NOT_EMPTY","value":"不空"}]}]];
    const searchFormFields = {"RuleName":"","AlertPage":"","FieldName":"","DayCount":"","advanceWarningDays":"","FinishStatusField":"","ConditionType":"","ConditionValue":"","ResponsiblePersonName":"","TriggerOA":""};
    const searchFormOptions = [[{"title":"规则名称","field":"RuleName","type":"like","comparationList":[{"key":"like","value":"模糊查询(包含)"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"dataKey":"预警页面","data":[],"title":"预警页面","field":"AlertPage","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"dataKey":"预警字段名","data":[],"title":"字段名","field":"FieldName","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"title":"阈值天数","field":"DayCount","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]}],[{"title":"提前预警天数","field":"advanceWarningDays","type":"number","comparationList":[{"key":"number","value":"number"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"dataKey":"预警字段名","data":[],"title":"完成状态字段","field":"FinishStatusField","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"dataKey":"完成判定方式","data":[],"title":"完成判定方式","field":"ConditionType","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"title":"完成判定值","field":"ConditionValue","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]}],[{"title":"责任人（OA接受人）","field":"ResponsiblePersonName","type":"like","comparationList":[{"key":"like","value":"模糊查询(包含)"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]},{"dataKey":"是否触发OA流程","data":[],"title":"是否触发OA流程","field":"TriggerOA","type":"=","comparationList":[{"key":"=","value":"等于"},{"key":"EMPTY","value":"空"},{"key":"NOT_EMPTY","value":"不空"}]}]];
    const columns = [{field:'ID',title:'主键ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'RuleName',title:'规则名称',type:'string',sort:true,width:140,require:true,align:'left'},
                       {field:'AlertPage',title:'预警页面',type:'string',bind:{ key:'预警页面',data:[]},sort:true,width:140,require:true,align:'left'},
                       {field:'FieldName',title:'字段名',type:'string',bind:{ key:'预警字段名',data:[]},sort:true,width:160,require:true,align:'left'},
                       {field:'DayCount',title:'阈值天数',type:'int',sort:true,width:120,require:true,align:'left'},
