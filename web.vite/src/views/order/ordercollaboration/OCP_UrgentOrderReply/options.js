...
export default function(){
    ...
    const key = table.key;
    const editFormFields = {"UrgentOrderID":"","ReplyContent":"","ReplyPersonName":"","ReplyPersonPhone":"","ReplyTime":"","ReplyProgress":"","ReplyDeliveryDate":"","Remarks":""};
    const editFormOptions = [[{"title":"催单ID","required":true,"field":"UrgentOrderID"}],
    ...
    const searchFormOptions = [[{"title":"回复ID","field":"ReplyID","type":"like"},{"title":"催单ID","field":"UrgentOrderID","type":"like"},{"title":"回复内容","field":"ReplyContent","type":"like"},{"title":"回复人名称","field":"ReplyPersonName","type":"like"}],[{"title":"回复人电话","field":"ReplyPersonPhone","type":"like"},{"title":"回复时间","field":"ReplyTime","type":"datetime"},{"title":"回复进度","field":"ReplyProgress","type":"like"},{"title":"回复交期","field":"ReplyDeliveryDate","type":"datetime"}],[{"title":"备注","field":"Remarks","type":"like"}]];
    const columns = [{field:'ReplyID',title:'回复ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'UrgentOrderID',title:'催单ID',type:'long',sort:true,width:80,require:true,align:'left'},
