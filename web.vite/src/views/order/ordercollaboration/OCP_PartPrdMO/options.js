...
export default function(){
    ...
    const searchFormOptions = [[{"title":"生产单据号","field":"ProductionOrderNo","type":"like"},{"title":"紧急等级","field":"Urgency","type":"like"},{"title":"生产类型","field":"ProductionType","type":"like"},{"title":"超期天数","field":"OverdueDays","type":"like"}]];
    ...
    const detail =  {
                    ...
                    columns: [{field:'DetailID',title:'明细ID',type:'long',sort:true,width:80,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'FID',title:'生产订单ID',type:'long',sort:true,width:80,hidden:true,edit:{type:''},align:'left'},
