...
export default function(){
    ...
    const columns = [{field:'WorkOrderNo',title:'WorkOrderNo',type:'string',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'ProductCode',title:'产品编号',type:'string',width:110,readonly:true,require:true,align:'left'},
                       {field:'CallerName',title:'计划跟踪号',type:'string',width:120,readonly:true,require:true,align:'left'},
                       {field:'CalledAt',title:'叫料时间',type:'datetime',width:110,readonly:true,require:true,align:'left'}];
