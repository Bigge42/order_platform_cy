    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'Dic_ID',title:'字典ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'DicNo',title:'字典编号',type:'string',width:140,require:true,align:'left',sort:true},
                       {field:'DicName',title:'字典名称',type:'string',link:true,width:100,require:true,align:'left'},
                       ...
                       {field:'OrderNo',title:'排序号',type:'int',width:90,align:'left',hidden:true},
                       ...
                       {field:'CreateDate',title:'创建时间',type:'datetime',width:130,readonly:true,align:'left',sort:true},
                       ...
                       {field:'ModifyDate',title:'修改时间',type:'datetime',width:130,readonly:true,align:'left',sort:true}]);
            const detail = ref(  {
                    cnName: '字典明细',
                    ...
                    columns: [{field:'DicList_ID',title:'DicList_ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'创建时间',type:'datetime',width:140,readonly:true,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:90,hidden:true,align:'left'},
