...
<script>
import { defineComponent, reactive, ref, watch, onMounted, computed, getCurrentInstance } from 'vue'
  ...
  setup() {
    const colors = reactive([
      ...
      { name: 'orange', color: '#ff9900' },
      {
        ...
        color: 'linear-gradient(to bottom, rgb(220,160,126),  rgb(250,230,170))'
      },
